...
static const char _svn_version[] =
    "$Id: luafflib.c 4650 2013-10-25 15:55:04Z khaled $ "
    "$URL: https://foundry.supelec.fr/svn/luatex/branches/kill-aat/source/texk/web2c/luatexdir/luafontloader/src/luafflib.c $";
