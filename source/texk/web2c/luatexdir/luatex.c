...
static const char _svn_version[] =
    "$Id: luatex.c 4634 2013-04-21 14:45:45Z hhenkel $ "
    "$URL: https://foundry.supelec.fr/svn/luatex/branches/ex-glyph/source/texk/web2c/luatexdir/luatex.c $";

#define TeX

int luatex_svn = luatex_svn_revision;
int luatex_version = 77;        /* \.{\\luatexversion}  */
int luatex_revision = '0';      /* \.{\\luatexrevision}  */
int luatex_date_info = -extra_version_info;     /* the compile date is negated */
const char *luatex_version_string = "beta-0.77.0";
