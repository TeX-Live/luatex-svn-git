...
#  define pdf_pk_resolution        get_tex_extension_count_register("pdfpkresolution",         72)
#  define pdf_unique_resname       get_tex_extension_count_register("pdfuniqueresname",         0)
#  define pdf_minor_version        get_tex_extension_count_register("pdfminorversion",          4)
#  define pdf_pagebox              get_tex_extension_count_register("pdfpagebox",               0)
#  define pdf_inclusion_errorlevel get_tex_extension_count_register("pdfinclusionerrorlevel",   0)
#  define pdf_gamma                get_tex_extension_count_register("pdfgamma",              1000)
#  define pdf_image_apply_gamma    get_tex_extension_count_register("pdfimageapplygamma",       0)
#  define pdf_image_gamma          get_tex_extension_count_register("pdfimagegamma",         2200)
#  define pdf_image_hicolor        get_tex_extension_count_register("pdfimagehicolor",          1)
...
#  define set_pdf_compress_level(i)   set_tex_extension_count_register("pdfcompresslevel",i)
#  define set_pdf_objcompresslevel(i) set_tex_extension_count_register("pdfobjcompresslevel",i)
