...
void initialize_commands(void)
{
    ...
    primitive_pdftex("pdfimageresolution", assign_int_cmd, int_base + pdf_image_resolution_code, int_base);
    primitive_pdftex("pdfpkresolution", assign_int_cmd, int_base + pdf_pk_resolution_code, int_base);
    primitive_pdftex("pdfuniqueresname", assign_int_cmd, int_base + pdf_unique_resname_code, int_base);
    primitive_pdftex("pdfoptionpdfminorversion", assign_int_cmd, int_base + pdf_minor_version_code, int_base);
    primitive_pdftex("pdfminorversion", assign_int_cmd, int_base + pdf_minor_version_code, int_base);
    primitive_pdftex("pdfpagebox", assign_int_cmd, int_base + pdf_pagebox_code, int_base);
    primitive_pdftex("pdfinclusionerrorlevel", assign_int_cmd, int_base + pdf_inclusion_errorlevel_code, int_base);
    primitive_pdftex("pdfgamma", assign_int_cmd, int_base + pdf_gamma_code, int_base);
    primitive_pdftex("pdfimagegamma", assign_int_cmd, int_base + pdf_image_gamma_code, int_base);
    primitive_pdftex("pdfimagehicolor", assign_int_cmd, int_base + pdf_image_hicolor_code, int_base);
    primitive_pdftex("pdfimageapplygamma", assign_int_cmd, int_base + pdf_image_apply_gamma_code, int_base);
...
@<Create a bunch of primitives@>=
    ...
    */
    ...
    primitive_umath("Ustopdisplaymath", math_shift_cs_cmd, cramped_display_style, 0);
    ...
    primitive_umath("Usuperscript", super_sub_script_cmd, sup_mark_cmd, sup_mark_cmd);
    primitive_umath("Usubscript", super_sub_script_cmd, sub_mark_cmd, sup_mark_cmd);
...
@<Create the math param primitives@>=
    primitive_umath("Umathoperatorsize", set_math_param_cmd, math_param_operator_size, 0);
    primitive_umath("Umathoverbarkern", set_math_param_cmd, math_param_overbar_kern, 0);
    primitive_umath("Umathoverbarrule", set_math_param_cmd, math_param_overbar_rule, 0);
    primitive_umath("Umathoverbarvgap", set_math_param_cmd, math_param_overbar_vgap, 0);
    primitive_umath("Umathunderbarkern", set_math_param_cmd, math_param_underbar_kern, 0);
    primitive_umath("Umathunderbarrule", set_math_param_cmd, math_param_underbar_rule, 0);
    primitive_umath("Umathunderbarvgap", set_math_param_cmd, math_param_underbar_vgap, 0);
    primitive_umath("Umathradicalkern", set_math_param_cmd, math_param_radical_kern, 0);
    primitive_umath("Umathradicalrule", set_math_param_cmd, math_param_radical_rule, 0);
    primitive_umath("Umathradicalvgap", set_math_param_cmd, math_param_radical_vgap, 0);
    primitive_umath("Umathradicaldegreebefore", set_math_param_cmd, math_param_radical_degree_before, 0);
    primitive_umath("Umathradicaldegreeafter", set_math_param_cmd, math_param_radical_degree_after, 0);
    primitive_umath("Umathradicaldegreeraise", set_math_param_cmd, math_param_radical_degree_raise, 0);
    primitive_umath("Umathstackvgap", set_math_param_cmd, math_param_stack_vgap, 0);
    primitive_umath("Umathstacknumup", set_math_param_cmd, math_param_stack_num_up, 0);
    primitive_umath("Umathstackdenomdown", set_math_param_cmd, math_param_stack_denom_down, 0);
    primitive_umath("Umathfractionrule", set_math_param_cmd, math_param_fraction_rule, 0);
    primitive_umath("Umathfractionnumvgap", set_math_param_cmd, math_param_fraction_num_vgap, 0);
    primitive_umath("Umathfractionnumup", set_math_param_cmd, math_param_fraction_num_up, 0);
    ...
    primitive_umath("Umathlimitbelowvgap", set_math_param_cmd, math_param_limit_below_vgap, 0);
    primitive_umath("Umathlimitbelowbgap", set_math_param_cmd, math_param_limit_below_bgap, 0);
    primitive_umath("Umathlimitbelowkern", set_math_param_cmd, math_param_limit_below_kern, 0);
    primitive_umath("Umathunderdelimitervgap", set_math_param_cmd, math_param_under_delimiter_vgap, 0);
    primitive_umath("Umathunderdelimiterbgap", set_math_param_cmd, math_param_under_delimiter_bgap, 0);
    primitive_umath("Umathoverdelimitervgap", set_math_param_cmd, math_param_over_delimiter_vgap, 0);
    primitive_umath("Umathoverdelimiterbgap", set_math_param_cmd, math_param_over_delimiter_bgap, 0);
    primitive_umath("Umathsubshiftdrop", set_math_param_cmd, math_param_sub_shift_drop, 0);
    primitive_umath("Umathsupshiftdrop", set_math_param_cmd, math_param_sup_shift_drop, 0);
    primitive_umath("Umathsubshiftdown", set_math_param_cmd, math_param_sub_shift_down, 0);
    primitive_umath("Umathsubsupshiftdown", set_math_param_cmd, math_param_sub_sup_shift_down, 0);
    primitive_umath("Umathsubtopmax", set_math_param_cmd, math_param_sub_top_max, 0);
    primitive_umath("Umathsupshiftup", set_math_param_cmd, math_param_sup_shift_up, 0);
    primitive_umath("Umathsupbottommin", set_math_param_cmd, math_param_sup_bottom_min, 0);
    primitive_umath("Umathsupsubbottommax", set_math_param_cmd, math_param_sup_sub_bottom_max, 0);
    primitive_umath("Umathsubsupvgap", set_math_param_cmd, math_param_subsup_vgap, 0);
    primitive_umath("Umathspaceafterscript", set_math_param_cmd, math_param_space_after_script, 0);
    primitive_umath("Umathconnectoroverlapmin", set_math_param_cmd, math_param_connector_overlap_min, 0);
    primitive_umath("Umathordordspacing", set_math_param_cmd, math_param_ord_ord_spacing, 0);
    primitive_umath("Umathordopspacing", set_math_param_cmd, math_param_ord_op_spacing, 0);
    primitive_umath("Umathordbinspacing", set_math_param_cmd, math_param_ord_bin_spacing, 0);
    primitive_umath("Umathordrelspacing", set_math_param_cmd, math_param_ord_rel_spacing, 0);
    primitive_umath("Umathordopenspacing", set_math_param_cmd, math_param_ord_open_spacing, 0);
    primitive_umath("Umathordclosespacing", set_math_param_cmd, math_param_ord_close_spacing, 0);
    primitive_umath("Umathordpunctspacing", set_math_param_cmd, math_param_ord_punct_spacing, 0);
    primitive_umath("Umathordinnerspacing", set_math_param_cmd, math_param_ord_inner_spacing, 0);
    primitive_umath("Umathopordspacing", set_math_param_cmd, math_param_op_ord_spacing, 0);
    primitive_umath("Umathopopspacing", set_math_param_cmd, math_param_op_op_spacing, 0);
    primitive_umath("Umathopbinspacing", set_math_param_cmd, math_param_op_bin_spacing, 0);
    primitive_umath("Umathoprelspacing", set_math_param_cmd, math_param_op_rel_spacing, 0);
    primitive_umath("Umathopopenspacing", set_math_param_cmd, math_param_op_open_spacing, 0);
    primitive_umath("Umathopclosespacing", set_math_param_cmd, math_param_op_close_spacing, 0);
    primitive_umath("Umathoppunctspacing", set_math_param_cmd, math_param_op_punct_spacing, 0);
    primitive_umath("Umathopinnerspacing", set_math_param_cmd, math_param_op_inner_spacing, 0);
    primitive_umath("Umathbinordspacing", set_math_param_cmd, math_param_bin_ord_spacing, 0);
    primitive_umath("Umathbinopspacing", set_math_param_cmd, math_param_bin_op_spacing, 0);
    primitive_umath("Umathbinbinspacing", set_math_param_cmd, math_param_bin_bin_spacing, 0);
    primitive_umath("Umathbinrelspacing", set_math_param_cmd, math_param_bin_rel_spacing, 0);
    primitive_umath("Umathbinopenspacing", set_math_param_cmd, math_param_bin_open_spacing, 0);
    primitive_umath("Umathbinclosespacing", set_math_param_cmd, math_param_bin_close_spacing, 0);
    primitive_umath("Umathbinpunctspacing", set_math_param_cmd, math_param_bin_punct_spacing, 0);
    primitive_umath("Umathbininnerspacing", set_math_param_cmd, math_param_bin_inner_spacing, 0);
    primitive_umath("Umathrelordspacing", set_math_param_cmd, math_param_rel_ord_spacing, 0);
    primitive_umath("Umathrelopspacing", set_math_param_cmd, math_param_rel_op_spacing, 0);
    primitive_umath("Umathrelbinspacing", set_math_param_cmd, math_param_rel_bin_spacing, 0);
    primitive_umath("Umathrelrelspacing", set_math_param_cmd, math_param_rel_rel_spacing, 0);
    primitive_umath("Umathrelopenspacing", set_math_param_cmd, math_param_rel_open_spacing, 0);
    primitive_umath("Umathrelclosespacing", set_math_param_cmd, math_param_rel_close_spacing, 0);
    primitive_umath("Umathrelpunctspacing", set_math_param_cmd, math_param_rel_punct_spacing, 0);
    primitive_umath("Umathrelinnerspacing", set_math_param_cmd, math_param_rel_inner_spacing, 0);
    primitive_umath("Umathopenordspacing", set_math_param_cmd, math_param_open_ord_spacing, 0);
    primitive_umath("Umathopenopspacing", set_math_param_cmd, math_param_open_op_spacing, 0);
    primitive_umath("Umathopenbinspacing", set_math_param_cmd, math_param_open_bin_spacing, 0);
    primitive_umath("Umathopenrelspacing", set_math_param_cmd, math_param_open_rel_spacing, 0);
    primitive_umath("Umathopenopenspacing", set_math_param_cmd, math_param_open_open_spacing, 0);
    primitive_umath("Umathopenclosespacing", set_math_param_cmd, math_param_open_close_spacing, 0);
    primitive_umath("Umathopenpunctspacing", set_math_param_cmd, math_param_open_punct_spacing, 0);
    primitive_umath("Umathopeninnerspacing", set_math_param_cmd, math_param_open_inner_spacing, 0);
    primitive_umath("Umathcloseordspacing", set_math_param_cmd, math_param_close_ord_spacing, 0);
    primitive_umath("Umathcloseopspacing", set_math_param_cmd, math_param_close_op_spacing, 0);
    primitive_umath("Umathclosebinspacing", set_math_param_cmd, math_param_close_bin_spacing, 0);
    primitive_umath("Umathcloserelspacing", set_math_param_cmd, math_param_close_rel_spacing, 0);
    primitive_umath("Umathcloseopenspacing", set_math_param_cmd, math_param_close_open_spacing, 0);
    primitive_umath("Umathcloseclosespacing", set_math_param_cmd, math_param_close_close_spacing, 0);
    primitive_umath("Umathclosepunctspacing", set_math_param_cmd, math_param_close_punct_spacing, 0);
    primitive_umath("Umathcloseinnerspacing", set_math_param_cmd, math_param_close_inner_spacing, 0);
    primitive_umath("Umathpunctordspacing", set_math_param_cmd, math_param_punct_ord_spacing, 0);
    primitive_umath("Umathpunctopspacing", set_math_param_cmd, math_param_punct_op_spacing, 0);
    primitive_umath("Umathpunctbinspacing", set_math_param_cmd, math_param_punct_bin_spacing, 0);
    primitive_umath("Umathpunctrelspacing", set_math_param_cmd, math_param_punct_rel_spacing, 0);
    primitive_umath("Umathpunctopenspacing", set_math_param_cmd, math_param_punct_open_spacing, 0);
    primitive_umath("Umathpunctclosespacing", set_math_param_cmd, math_param_punct_close_spacing, 0);
    primitive_umath("Umathpunctpunctspacing", set_math_param_cmd, math_param_punct_punct_spacing, 0);
    primitive_umath("Umathpunctinnerspacing", set_math_param_cmd, math_param_punct_inner_spacing, 0);
    primitive_umath("Umathinnerordspacing", set_math_param_cmd, math_param_inner_ord_spacing, 0);
    primitive_umath("Umathinneropspacing", set_math_param_cmd, math_param_inner_op_spacing, 0);
    primitive_umath("Umathinnerbinspacing", set_math_param_cmd, math_param_inner_bin_spacing, 0);
    primitive_umath("Umathinnerrelspacing", set_math_param_cmd, math_param_inner_rel_spacing, 0);
    primitive_umath("Umathinneropenspacing", set_math_param_cmd, math_param_inner_open_spacing, 0);
    primitive_umath("Umathinnerclosespacing", set_math_param_cmd, math_param_inner_close_spacing, 0);
    primitive_umath("Umathinnerpunctspacing", set_math_param_cmd, math_param_inner_punct_spacing, 0);
    primitive_umath("Umathinnerinnerspacing", set_math_param_cmd, math_param_inner_inner_spacing, 0);

@ These are in a separate module due to a CWEAVE limitation.

@<Create another bunch of primitives@>=
    primitive_umath("Umathcode", extdef_math_code_cmd, math_code_base, math_code_base);
    primitive_umath("Udelcode", extdef_del_code_cmd, del_code_base, del_code_base);
    primitive_umath("Umathcodenum", extdef_math_code_cmd, math_code_base + 1, math_code_base);
    primitive_umath("Udelcodenum", extdef_del_code_cmd, del_code_base + 1, del_code_base);
    ...
    primitive_pdftex("pdfincludechars", extension_cmd, pdf_include_chars_code, 0);
    ...
    primitive_luatex("savecatcodetable", extension_cmd, save_cat_code_table_code, 0);
    primitive_luatex("initcatcodetable", extension_cmd, init_cat_code_table_code, 0);
    primitive_luatex("setrandomseed", extension_cmd, set_random_seed_code, 0);
    ...
    primitive_pdftex("pdfglyphtounicode", extension_cmd, pdf_glyph_to_unicode_code, 0);
