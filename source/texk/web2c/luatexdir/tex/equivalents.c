...
{
    switch (n) {
    case pretolerance_code: tprint_esc("pretolerance"); break;
    case tolerance_code: tprint_esc("tolerance"); break;
    case line_penalty_code: tprint_esc("linepenalty"); break;
    case hyphen_penalty_code: tprint_esc("hyphenpenalty"); break;
    case ex_hyphen_penalty_code: tprint_esc("exhyphenpenalty"); break;
    case club_penalty_code: tprint_esc("clubpenalty"); break;
    case widow_penalty_code: tprint_esc("widowpenalty"); break;
    case display_widow_penalty_code: tprint_esc("displaywidowpenalty"); break;
    case broken_penalty_code: tprint_esc("brokenpenalty"); break;
    case bin_op_penalty_code: tprint_esc("binoppenalty"); break;
    case rel_penalty_code: tprint_esc("relpenalty"); break;
    case pre_display_penalty_code: tprint_esc("predisplaypenalty"); break;
    case post_display_penalty_code: tprint_esc("postdisplaypenalty"); break;
    case inter_line_penalty_code: tprint_esc("interlinepenalty"); break;
    case double_hyphen_demerits_code: tprint_esc("doublehyphendemerits"); break;
    case final_hyphen_demerits_code: tprint_esc("finalhyphendemerits"); break;
    case adj_demerits_code: tprint_esc("adjdemerits"); break;
    case mag_code: tprint_esc("mag"); break;
    case delimiter_factor_code: tprint_esc("delimiterfactor"); break;
    case looseness_code: tprint_esc("looseness"); break;
    case time_code: tprint_esc("time"); break;
    case day_code: tprint_esc("day"); break;
    case month_code: tprint_esc("month"); break;
    case year_code: tprint_esc("year"); break;
    case show_box_breadth_code: tprint_esc("showboxbreadth"); break;
    case show_box_depth_code: tprint_esc("showboxdepth"); break;
    case hbadness_code: tprint_esc("hbadness"); break;
    case vbadness_code: tprint_esc("vbadness"); break;
    case pausing_code: tprint_esc("pausing"); break;
    case tracing_online_code: tprint_esc("tracingonline"); break;
    case tracing_macros_code: tprint_esc("tracingmacros"); break;
    case tracing_stats_code: tprint_esc("tracingstats"); break;
    case tracing_paragraphs_code: tprint_esc("tracingparagraphs"); break;
    case tracing_pages_code: tprint_esc("tracingpages"); break;
    case tracing_output_code: tprint_esc("tracingoutput"); break;
    case tracing_lost_chars_code: tprint_esc("tracinglostchars"); break;
    case tracing_commands_code: tprint_esc("tracingcommands"); break;
    case tracing_restores_code: tprint_esc("tracingrestores"); break;
    case uc_hyph_code: tprint_esc("uchyph"); break;
    case output_penalty_code: tprint_esc("outputpenalty"); break;
    case max_dead_cycles_code: tprint_esc("maxdeadcycles"); break;
    case hang_after_code: tprint_esc("hangafter"); break;
    case floating_penalty_code: tprint_esc("floatingpenalty"); break;
    case global_defs_code: tprint_esc("globaldefs"); break;
    case cur_fam_code: tprint_esc("fam"); break;
    case escape_char_code: tprint_esc("escapechar"); break;
    case default_hyphen_char_code: tprint_esc("defaulthyphenchar"); break;
    case default_skew_char_code: tprint_esc("defaultskewchar"); break;
    case end_line_char_code: tprint_esc("endlinechar"); break;
    case new_line_char_code: tprint_esc("newlinechar"); break;
    case language_code: tprint_esc("language"); break;
    case cur_lang_code: tprint_esc("setlanguage"); break;
    case ex_hyphen_char_code: tprint_esc("exhyphenchar"); break;
    case left_hyphen_min_code: tprint_esc("lefthyphenmin"); break;
    case right_hyphen_min_code: tprint_esc("righthyphenmin"); break;
    case holding_inserts_code: tprint_esc("holdinginserts"); break;
    case error_context_lines_code: tprint_esc("errorcontextlines"); break;
    case luastartup_id_code: tprint_esc("luastartup"); break;
    case disable_lig_code: tprint_esc("noligs"); break;
    case disable_kern_code: tprint_esc("nokerns"); break;
    case cat_code_table_code: tprint_esc("catcodetable"); break;
    case output_box_code: tprint_esc("outputbox"); break;
    case local_inter_line_penalty_code: tprint_esc("localinterlinepenalty"); break;
    case local_broken_penalty_code: tprint_esc("localbrokenpenalty"); break;
    case pdf_output_code:           tprint_esc("pdfoutput"); break;
    case pdf_compress_level_code:   tprint_esc("pdfcompresslevel"); break;
    case pdf_objcompresslevel_code: tprint_esc("pdfobjcompresslevel"); break;
    case pdf_decimal_digits_code:   tprint_esc("pdfdecimaldigits"); break;
    case pdf_image_resolution_code: tprint_esc("pdfimageresolution"); break;
    case pdf_pk_resolution_code:    tprint_esc("pdfpkresolution"); break;
    case pdf_unique_resname_code:   tprint_esc("pdfuniqueresname"); break;
    case pdf_minor_version_code: tprint_esc("pdfminorversion"); break;
    case pdf_pagebox_code: tprint_esc("pdfpagebox"); break;
    case pdf_inclusion_errorlevel_code: tprint_esc("pdfinclusionerrorlevel"); break;
    case pdf_gamma_code:            tprint_esc("pdfgamma"); break;
    case pdf_image_gamma_code:      tprint_esc("pdfimagegamma"); break;
    case pdf_image_hicolor_code:    tprint_esc("pdfimagehicolor"); break;
    case pdf_image_apply_gamma_code: tprint_esc("pdfimageapplygamma"); break;
    case pdf_adjust_spacing_code:   tprint_esc("pdfadjustspacing"); break;
    case pdf_protrude_chars_code:   tprint_esc("pdfprotrudechars"); break;
    case pdf_tracing_fonts_code:    tprint_esc("pdftracingfonts"); break;
    case pdf_gen_tounicode_code:    tprint_esc("pdfgentounicode"); break;
    case pdf_draftmode_code:        tprint_esc("pdfdraftmode"); break;
    case pdf_inclusion_copy_font_code:    tprint_esc("pdfinclusioncopyfonts"); break;
    case pdf_replace_font_code:    tprint_esc("pdfreplacefont"); break;
    case tracing_assigns_code: tprint_esc("tracingassigns"); break;
    case tracing_groups_code: tprint_esc("tracinggroups"); break;
    case tracing_ifs_code: tprint_esc("tracingifs"); break;
    case tracing_scan_tokens_code: tprint_esc("tracingscantokens"); break;
    case tracing_nesting_code: tprint_esc("tracingnesting"); break;
    case pre_display_direction_code: tprint_esc("predisplaydirection"); break;
    case last_line_fit_code: tprint_esc("lastlinefit"); break;
    case saving_vdiscards_code: tprint_esc("savingvdiscards"); break;
    case saving_hyph_codes_code: tprint_esc("savinghyphcodes"); break;
    case suppress_fontnotfound_error_code: tprint_esc("suppressfontnotfounderror"); break;
    case suppress_long_error_code: tprint_esc("suppresslongerror"); break;
    case suppress_outer_error_code: tprint_esc("suppressoutererror"); break;
    case synctex_code: tprint_esc("synctex"); break;
    /* the next three do not have a matching primitive */
    case no_local_whatsits_code: tprint("[no_local_whatsits]"); break;
    case no_local_dirs_code: tprint("[no_local_dirs]"); break;
    case level_local_dir_code: tprint("[level_local_dir]"); break;
    default: tprint("[unknown integer parameter!]"); break;
    }
}
...
{
    switch(n) {
    case par_indent_code: tprint_esc("parindent"); break;
    case math_surround_code: tprint_esc("mathsurround"); break;
    case line_skip_limit_code: tprint_esc("lineskiplimit"); break;
    case hsize_code: tprint_esc("hsize"); break;
    case vsize_code: tprint_esc("vsize"); break;
    case max_depth_code: tprint_esc("maxdepth"); break;
    case split_max_depth_code: tprint_esc("splitmaxdepth"); break;
    case box_max_depth_code: tprint_esc("boxmaxdepth"); break;
    case hfuzz_code: tprint_esc("hfuzz"); break;
    case vfuzz_code: tprint_esc("vfuzz"); break;
    case delimiter_shortfall_code: tprint_esc("delimitershortfall"); break;
    case null_delimiter_space_code: tprint_esc("nulldelimiterspace"); break;
    case script_space_code: tprint_esc("scriptspace"); break;
    case pre_display_size_code: tprint_esc("predisplaysize"); break;
    case display_width_code: tprint_esc("displaywidth"); break;
    case display_indent_code: tprint_esc("displayindent"); break;
    case overfull_rule_code: tprint_esc("overfullrule"); break;
    case hang_indent_code: tprint_esc("hangindent"); break;
    case h_offset_code: tprint_esc("hoffset"); break;
    case v_offset_code: tprint_esc("voffset"); break;
    case emergency_stretch_code: tprint_esc("emergencystretch"); break;
    case page_left_offset_code:   tprint_esc("pageleftoffset"); break;
    case page_top_offset_code:    tprint_esc("pagetopoffset"); break;
    case page_right_offset_code:  tprint_esc("pagerightoffset"); break;
    case page_bottom_offset_code: tprint_esc("pagebottomoffset"); break;
    case pdf_h_origin_code:       tprint_esc("pdfhorigin"); break;
    case pdf_v_origin_code:       tprint_esc("pdfvorigin"); break;
    case page_width_code:     tprint_esc("pagewidth"); break;
    case page_height_code:    tprint_esc("pageheight"); break;
    case pdf_link_margin_code:    tprint_esc("pdflinkmargin"); break;
    case pdf_dest_margin_code:    tprint_esc("pdfdestmargin"); break;
    case pdf_thread_margin_code:  tprint_esc("pdfthreadmargin"); break;
    case pdf_first_line_height_code:  tprint_esc("pdffirstlineheight"); break;
    case pdf_last_line_depth_code:  tprint_esc("pdflastlinedepth"); break;
    case pdf_each_line_height_code:  tprint_esc("pdfeachlineheight"); break;
    case pdf_each_line_depth_code:  tprint_esc("pdfeachlinedepth"); break;
    case pdf_ignored_dimen_code:  tprint_esc("pdfignoreddimen"); break;
    case pdf_px_dimen_code:       tprint_esc("pdfpxdimen"); break;
    default: tprint("[unknown dimen parameter!]"); break;
    }
}
...
void eq_save(halfword p, quarterword l) /* saves |eqtb[p]| */
{
    check_full_save_stack();
    if (l==level_zero) {
...
void eq_define(halfword p, quarterword t, halfword e) /* new data for |eqtb| */
{
...
void geq_define(halfword p, quarterword t, halfword e) /* global |eq_define| */
{
...
void geq_word_define(halfword p, integer w) /* global |eq_word_define| */
{
    assign_trace(p,"globally changing");
    eqtb[p].cint=w; 
...
void restore_trace(halfword p, char *s)  /* |eqtb[p]| has just been restored or retained */
{
    begin_diagnostic(); 
    print_char('{'); 
    tprint(s); 
