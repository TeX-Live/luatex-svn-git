...
void initialize_commands (void)
{
    ...
    */
    ...
    primitive_pdftex("pdfadjustspacing",assign_int_cmd,int_base+pdf_adjust_spacing_code,int_base);
    primitive_pdftex("pdfprotrudechars",assign_int_cmd,int_base+pdf_protrude_chars_code,int_base);
    ...
    primitive_omega("pagewidth",assign_dimen_cmd,dimen_base+page_width_code,dimen_base);
    primitive_pdftex("pdfpagewidth",assign_dimen_cmd,dimen_base+page_width_code,dimen_base);
    primitive_omega("pageheight",assign_dimen_cmd,dimen_base+page_height_code,dimen_base);
    primitive_pdftex("pdfpageheight",assign_dimen_cmd,dimen_base+page_height_code,dimen_base);
    ...
    primitive_pdftex("pdffirstlineheight",assign_dimen_cmd,dimen_base+pdf_first_line_height_code,dimen_base);
    primitive_pdftex("pdflastlinedepth",assign_dimen_cmd,dimen_base+pdf_last_line_depth_code,dimen_base);
    primitive_pdftex("pdfeachlineheight",assign_dimen_cmd,dimen_base+pdf_each_line_height_code,dimen_base);
    primitive_pdftex("pdfeachlinedepth",assign_dimen_cmd,dimen_base+pdf_each_line_depth_code,dimen_base);
    primitive_pdftex("pdfignoreddimen",assign_dimen_cmd,dimen_base+pdf_ignored_dimen_code,dimen_base);
    ...
    */
    ...
    primitive_omega("omathcode",extdef_math_code_cmd,math_code_base,math_code_base);
    primitive_omega("odelcode",extdef_del_code_cmd,del_code_base,del_code_base);
    primitive_luatex("Umathcode",extdef_math_code_cmd,math_code_base+1,math_code_base);
    primitive_luatex("Udelcode",extdef_del_code_cmd,del_code_base+1,del_code_base);
    primitive_luatex("Umathcodenum",extdef_math_code_cmd,math_code_base+2,math_code_base);
    primitive_luatex("Udelcodenum",extdef_del_code_cmd,del_code_base+2,del_code_base);
    ...
    primitive_omega("localinterlinepenalty",assign_int_cmd,int_base+local_inter_line_penalty_code,int_base);
    primitive_omega("localbrokenpenalty",assign_int_cmd,int_base+local_broken_penalty_code,int_base);
    primitive_omega("pagedir",assign_dir_cmd,dir_base+page_direction_code,dir_base);
    primitive_omega("bodydir",assign_dir_cmd,dir_base+body_direction_code,dir_base);
    primitive_omega("pardir",assign_dir_cmd,dir_base+par_direction_code,dir_base);
    primitive_omega("textdir",assign_dir_cmd,dir_base+text_direction_code,dir_base);
    primitive_omega("mathdir",assign_dir_cmd,dir_base+math_direction_code,dir_base);
    ...
    primitive_aleph("pagerightoffset",assign_dimen_cmd,dimen_base+page_right_offset_code,dimen_base);
    primitive_aleph("pagebottomoffset",assign_dimen_cmd,dimen_base+page_bottom_offset_code,dimen_base);
    ...
    primitive_pdftex("pdfsetrandomseed",extension_cmd,set_random_seed_code,0);
    ...
    primitive_omega("removebeforeocplist",ocp_list_op_cmd, remove_before_op,0);
...
void initialize_etex_commands (void)
{
    ...
    primitive_aleph("Alephminorversion",last_item_cmd,Aleph_minor_version_code,0);
    primitive_aleph("Omegaminorversion",last_item_cmd,Omega_minor_version_code,0);
