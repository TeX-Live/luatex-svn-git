...
typedef enum {
    math_param_quad,                               
    math_param_axis,                               
    math_param_overbar_above_clearance,            
    math_param_overbar_rule,                       
    math_param_overbar_vgap,                       
    math_param_underbar_below_clearance,           
    math_param_underbar_rule,                      
    math_param_underbar_vgap,                      
    math_param_radical_above_clearance,            
    ...
    math_param_fraction_delimiter_size,            
    math_param_limit_up_gap,                       
    math_param_limit_up_baseline_gap,              
    math_param_limit_up_above_clearance,           
    math_param_limit_down_gap,                     
    math_param_limit_down_baseline_gap,            
    math_param_limit_down_below_clearance,         
    math_param_subscript_shift_baseline_drop,      
    math_param_superscript_shift_baseline_drop,    
    math_param_subscript_shift_down,               
    math_param_subscript_shift_down_with_sup,      
    math_param_subscript_top_max,                  
    math_param_superscript_shift_up,               
    math_param_superscript_bottom_min,             
    math_param_superscript_bottom_max_with_sub,    
    math_param_subsuperscript_gap,                 
