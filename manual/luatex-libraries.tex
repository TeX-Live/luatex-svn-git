...
We have similar setters for \type {count}, \type {dimen} and \type {toks}. For
tokens registers we have an alternative where a catcode table is specified:
...
\starttyping
local index = tex.setboxresource(n,attributes,resources)
\stoptyping
