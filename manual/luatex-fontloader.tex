...
\subsection[fontloaderpfminfotable]{\type {pfminfo}}
...
\subsection[fontloadernamestable]{\type {names}}
...
\subsection{\type {ttf_tables} and \type {ttf_tab_saved}}
...
\subsection{\type {validation_state}}
...
\subsection{\type {horiz_base} and \type {vert_base}}
...
\subsection{\type {vert_variants} and \type {horiz_variants}}
...
\subsection{\type {kerns}}

Substructure is identical to the per|-|glyph subtable.

\subsection{\type {vkerns}}

Substructure is identical to the per|-|glyph subtable.

\subsection{\type {texdata}}
