...
\setupheadertexts[Luatex 0.60 short reference (preliminary)][pagenumber]
...
\tex{directlua}\type{} expands immediately, \tex{latexlua}\type{}
...
\presentfunction{callback}{find_ocp_file}
...
\presentfunction{callback}{read_ocp_file}
...
\presentfunction{callback}{finish_pdf_file}
...
The items above can also be accessed directly via virtual arrays:
\type{tex.attributes[]}, \type{tex.box[]}, \type{tex.count[]}, \type{tex.dimen[]},
\type{tex.skip[]}, \type{tex.toks[]}.
