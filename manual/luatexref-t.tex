...
\NC design_size                  \NC number   \NC (since 0.78.2) \NC\NR
\NC design_range_bottom          \NC number   \NC (since 0.78.2) \NC\NR
\NC design_range_top             \NC number   \NC (since 0.78.2) \NC\NR
...
\NC names                        \NC table    \NC (since 0.78.2) (see \in{section}[fontloadernamestable])\NC\NR
\stoptabulate
