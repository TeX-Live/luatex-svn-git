...
to be available sometime in the summer of~2008.
...
commands like \type{mathcode} and \type{omathcode}. The traditional
...
\luatex{node} and \luatex{pdf}, are off|-|limits during the execution of the startup file (they are
...
\item \lua{luafilesystem}, also from the kepler project, \hyphenatedurl{http://www.keplerproject.org/luafilesystem/}.
  (version 1.2, but patched for compilation with \LUA\ 5.2)
...
is based on the \MPLIB\ beta version 0.45 (based on \MP\ 1.004).
...
\NC half_error_line \NC    number \NC \quote {half} of line width \NC 50 \NC\NR
...
\NC mem_name \NC           string \NC \type {--mem}\NC \type {plain.mem}\NC\NR
...
You can ask the \METAPOST\ interpreter to run a bit of code by calling
...
\NC begin_of_par    \NC the beginning of a new paragraph       \NC\NR
...
All languages start out with \tex{prehyphenchar=`\-} and
\tex{posthyphenchar=0}. When you assign the values of
...
A note on \type{dir} strings. There is a grand total of 32 different
possible direction strings, as follows:

\starttabulate[|Tc|c|c|c|]
\NC \ssbf number \NC \bf meaning \NC \bf number \NC \bf meaning \NC\NR
\NC 0            \NC TLT         \NC 16         \NC BLT     \NC\NR
\NC 1            \NC TLL         \NC 17         \NC BLL     \NC\NR
\NC 2            \NC TLB         \NC 18         \NC BLB     \NC\NR
\NC 3            \NC TLR         \NC 19         \NC BLR     \NC\NR
\NC 4            \NC TRT         \NC 20         \NC BRT     \NC\NR
\NC 5            \NC TRL         \NC 21         \NC BRL     \NC\NR
\NC 6            \NC TRB         \NC 22         \NC BRB     \NC\NR
\NC 7            \NC TRR         \NC 23         \NC BRR     \NC\NR
\NC 8            \NC LTT         \NC 24         \NC RTT     \NC\NR
\NC 9            \NC LTL         \NC 25         \NC RTL     \NC\NR
\NC 10           \NC LTB         \NC 26         \NC RTB     \NC\NR
\NC 11           \NC LTR         \NC 27         \NC RTR     \NC\NR
\NC 12           \NC LBT         \NC 28         \NC RBT     \NC\NR
\NC 13           \NC LBL         \NC 29         \NC RBL     \NC\NR
\NC 14           \NC LBB         \NC 30         \NC RBB     \NC\NR
\NC 15           \NC LBR         \NC 31         \NC RBR     \NC\NR
\stoptabulate
...
each other, which limits the total to 32.
...
this is nor roadmap, which is somewhat more ambitious.
