...
\item A subtype, split into four main types:
   ...
   \startitemize
   \item \type{character}, for characters to be hyphenated
   \item \type{glyph}, for specific font glyphs
   \item \type{ligature}, for ligatures
   \item \type{ghost}, for \quote{ghost objects}
   \stopitemize
