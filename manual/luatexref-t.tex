...
\startfunctioncall
<table> info = fontloader.info('filename')
\stopfunctioncall
...
(or \type{nil}, if there is no second argument). The return values are scaled
...
The keyword \type{bot} after \tex{Umathaccent} signals that a bottom
