...
\startfunctioncall
<int>   = <Annots>:getNumAnnots()
<Annot> = <Annots>:getAnnot()
\stopfunctioncall
...
<int>    = <Array>:getLength()
           <Array>:add(<Object>)
<Object> = <Array>:get(<int>)
<Object> = <Array>:getNF(<int>)
<string> = <Array>:getString(<int>)
\stopfunctioncall
...
<Page>     = <Catalog>:getPage(<int>)
<Ref>      = <Catalog>:getPageRef(<int>)
<string>   = <Catalog>:getBaseURI()
<string>   = <Catalog>:readMetadata()
<Object>   = <Catalog>:getStructTreeRoot()
<int>      = <Catalog>:findPage(<int> object number, <int> object generation)
