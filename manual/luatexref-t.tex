...
If in post 0.70 you want the functionality of these tables back, you can add
\LUA\ code to do that for you, like this:
...
linebreaking, 2 = explict box command. (0.46.0), 3 = paragraph indentation box (0.62.0)\NC\NR
