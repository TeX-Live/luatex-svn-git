...
\NC shell_escape    \NC    string\NC Use \type{'y'} or \type{'t'} or \type{'1'} to enable \type{\write18} unconditionally, 
                                     \type{'p'} to enable the commands that are listed in \type{shell_escape_commands} (new in 0.37)\NC\NR
\NC shell_escape_commands \NC string\NC Comma-separated list of command names that may be executed by \type{\write18} even
