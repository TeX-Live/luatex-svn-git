...
But if the \type{--lua} option is present, \LUATEX\ will enter an alternative mode
...
fictional \type{of-f-ice} example.
...
subtype 5.  The reason for these special subtypes is that not all of
the fields are in their \quote{normal} location, like the \type{<ff>-}
that appears in \type{disc2.replace}.
