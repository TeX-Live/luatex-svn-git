...
The set that has a \type{g} prefix does global assignment when
used to set a value.  These are new in version 0.39.0, and
somewhat experimental; the syntax or name may change in the future.
...
tex.gsetskip (<number> n, <node> s)
tex.gsetskip (<string> s, <node> s)
...
and the second string is the style name minus the traling \quote{style}.
...
succesful use, this callback has to be set in the lua initialization file,
