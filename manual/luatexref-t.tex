...
\NC --[no-]parse-first-line   \NC disable/enable parsing of the first line of the
                                  input file (ignored, only a message in the log)\NC \NR
...
\item The \tex{pdftexversion} was set to 200, but from \LUATEX~0.80.0 returns the luatex version and is declared as obsolete (i.e. it will disappear).
