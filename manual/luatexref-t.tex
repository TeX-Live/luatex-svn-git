...
\NC \tex{Uradical}    \NC 8+21           \NC \tt7FFFFFF + ~FFFFFF          \NC\NR
...
\subsubsubsection{ord, op, bin, rel, open, close, punct, inner, vcenter,
  under, over nodes}
...
\starttabulate[|lT|l|p|]
\NC \ssbf field     \NC \bf type  \NC  \bf explanation \NC\NR
\NC subtype    \NC number         \NC  unused except for \quote{op} \NC\NR
\NC attr       \NC \syntax{<node>}\NC          \NC\NR
...
In \quote{op} nodes, the \type{subtype} is a numeric value representing
the \quote{limits} state. 0 = \type{\displaylimits}, 
1 = \type{\limits}, 2 = \type{\nolimits}.
...
\subsubsubsection{left nodes}

Valid fields: \showfields{left}
...
\subsubsubsection{right nodes}

Valid fields: \showfields{right}


\starttabulate[|lT|l|p|]
\NC \ssbf field     \NC \bf type  \NC  \bf explanation \NC\NR
\NC subtype    \NC number         \NC is 1 for a \type{\middle} item\NC\NR
\NC attr       \NC \syntax{<node>}\NC          \NC\NR
\NC delim       \NC \syntax{<delim>}\NC          \NC \NR
\stoptabulate
