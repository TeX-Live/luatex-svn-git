...
Note 1: Opentype fonts set \tex{Umathfractiondelsize}, \tex{Umathlimitabovekern}, \tex{Umathlimitbelowkern}
to zero and set \tex{Umathquad} to the font size of the used font, because these are not supported in the
MATH table,
...
compatibility mode will kick in that assumes that an oldstyle \TeX\ font is used.
...
Note 5: Tfm fonts set \tex{Umathunderbarkern} to $0$ because \TeX82\ never adds a kern below the underbar.
