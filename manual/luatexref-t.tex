...
\subsubsubject{\luatex{pdf.mapline}, \luatex{pdf.mapfile} (new in 0.53.0)}
...
The corresponding ``\type{pdf}'' parameter names
\luatex{pdf.pdfmapline} and \luatex{pdf.pdfmapfile (all new in 0.47.0)
