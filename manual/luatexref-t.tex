...
Returns the first node in the list starting at \type{n} (up to \type{m}
or the end of the list) that is a glyph node with a subtype indicating
...
\subsubsubject{\luatex{pdf.refobj()}}
