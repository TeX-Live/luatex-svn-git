...
\NC stream        \NC string   \NC raw stream data for an \type{/Xobject} \type{/Form} object\NC \NR
...
The \type{bbox} key needs a table like \type{{"30bp", "0bp", "225bp", "200bp"}}.
It replaces and overrules any given \type{pagebox} value;
