...
\LUATEX\ accepts optional dimensions with \type{\pdfrefximage}
in the same format as with \type{\pdfximage}.
These dimensions are then used instead of the ones
given to \type{\pdfximage}.
...
% \pdfrefxform with dimensions to follow...
