...
is the \type {type} key. When set to 1 the created form will not have a \type
{/Type}, and when set to 2 no \type {BBox} and \type {/Matrix} will be written.
This is a way to get arbitrary content streams in a stream object.
