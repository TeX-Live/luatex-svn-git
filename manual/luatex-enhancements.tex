...
The primitive \type {\initcatcodetable} creates a new table with catcodes
...
\startplacefigure[reference=fig:nospaces,title={The \type {\nospaces} options.}]
...
\TB[small,samepage]
\NC \type {\saveboxresource}             \NC save the box as an object to be included later \NC \NR
\NC \type {\saveimageresource}           \NC save the image as an object to be includes later \NC \NR
\NC \type {\useboxresource}              \NC include the saved box object here (by index) \NC \NR
\NC \type {\useimageresource}            \NC include the saved image object here (by index) \NC \NR
\NC \type {\lastsavedboxresourceindex}   \NC the index of the last saved box object \NC \NR
\NC \type {\lastsavedimageresourceindex} \NC the index of the last saved image object \NC \NR
\NC \type {\lastsavedimageresourcepages} \NC the number of pages in the last saved image object \NC \NR
\stoptabulate
