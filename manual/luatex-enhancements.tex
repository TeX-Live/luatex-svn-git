...
\subsection{\lpr {expanded} and \lpr {immediateassignment}}

\topicindex {expansion}

The \lpr {expansion} primitive takes a token list and expands it content which
can come in handy: it avoids a tricky mix of \prm {expandafter} and \prm
{noexpand}. But it still doesn't expand some primitive operations.
