...
\subsubsection {\type {\mathoption compensateitalic}}
...
\startlinecorrection[blank]
    \startcombination[nx=2,ny=2]
        {\mathoption compensateitalic 0\relax \mathematics{\getbuffer}}
            {\type{0:inline}}
        {\mathoption compensateitalic 0\relax \mathematics{\displaymath\getbuffer}}
            {\type{0:display}}
        {\mathoption compensateitalic 1\relax \mathematics{\getbuffer}}
            {\type{1:inline}}
        {\mathoption compensateitalic 1\relax \mathematics{\displaymath\getbuffer}}
            {\type{1:display}}
    \stopcombination
\stoplinecorrection

\subsubsection {\type {\mathoption alwayscharitalic}}
...
\startlinecorrection[blank]
    \startcombination[nx=2,ny=2]
        {\mathoption alwayscharitalic 0\relax \mathematics{\getbuffer}}
            {\type{0:inline}}
        {\mathoption alwayscharitalic 0\relax \mathematics{\displaymath\getbuffer}}
            {\type{0:display}}
        {\mathoption alwayscharitalic 1\relax \mathematics{\getbuffer}}
            {\type{1:inline}}
        {\mathoption alwayscharitalic 1\relax \mathematics{\displaymath\getbuffer}}
            {\type{1:display}}
    \stopcombination
\stoplinecorrection
