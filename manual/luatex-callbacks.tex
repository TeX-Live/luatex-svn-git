...
reading problem. The list of functions is:
...
before \LUATEX\ actually starts writing it to a file as the result of a \prm {write} command. It is only called for output to an actual file (that is,
...
This callback is called when \TEX\ is ready to start boxing the box 255 for \prm {output}.
