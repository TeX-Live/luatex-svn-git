...
<image> var = img.immediatewriteobject(<image> var)
<image> var = img.immediatewriteobject(<table> image_spec)
\stopfunctioncall
...
\subsubsection{\type {get[boolean|numeric|string|path]}}
...
\startfunctioncall
<boolean> w = getboolean(mp,<string> name)
<number>  n = getnumeric(mp,<string> name)
<string>  s = getstring (mp,<string> name)
<table>   p = getpath   (mp,<string> name)
\stopfunctioncall
