...
with \type {\useimageresource} This only makes sense when you embed many pages.
An \type {\immediate} applied to \type {\saveimageresource} will also force a
close after inclusion.

\starttyping
\immediate\pdfximage{foo.pdf}\pdfrefximage         \pdflastximage % closed
          \pdfximage{foo.pdf}\pdfrefximage         \pdflastximage % kept open
          \pdfximage{foo.pdf}\pdfrefximage keepopen\pdflastximage % kept open
